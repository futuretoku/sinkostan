    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="space-y-4">
            ...
            <div class="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-100 flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <a href="{{ route('booking.payment_detail', $booking->id) }}" class="bg-slate-50 hover:bg-slate-100 text-slate-600 px-6 py-2 rounded-xl text-xs font-bold transition-all">
                    Detail
                </a>
            </div>
            @empty
